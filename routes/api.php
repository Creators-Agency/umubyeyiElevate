...
Route::prefix('menus')->group(function () {
    ...
    Route::get('/view/{id}', [MenuController::class, 'byFocusSingle']);
...
Route::prefix('chats')->group(function () {
    ...
    Route::post('/user/revoke/', [ChatUserController::class, 'revoke']);
    Route::post('/user/accept/', [ChatUserController::class, 'accepting']);
    Route::post('/user/leave/', [ChatUserController::class, 'leave']);
    Route::get('/user/{id}', [ChatController::class, 'displayChat']);
    Route::get('/user', [ChatUserController::class, 'all']);
    Route::get('/expert/{id}', [ChatUserController::class, 'byExpert']);
    Route::get('/expert/request/{id}', [ChatUserController::class, 'byExpertRequest']);
